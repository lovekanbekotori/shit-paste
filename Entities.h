...
#define TICK_INTERVAL			(Interfaces::g_Globals->interval_per_tick)
#define TIME_TO_TICKS( dt )		( (int)( 0.5f + (float)(dt) / TICK_INTERVAL ) )
#define TICKS_TO_TIME( t )		( Interfaces::g_Globals->interval_per_tick *( t ) )
...
//{ ItemDefinitionIndexx::WEAPON_MP5SD,{ "#SFUI_WPNHUD_MP5-SD", "WEAPON_MP5SD", "models/weapons/v_smg_mp5sd.mdl", "mp5sd" } },
