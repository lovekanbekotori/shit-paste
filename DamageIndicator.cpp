...
{
	auto m_local = Interfaces::g_EntityList->GetClientEntity(Interfaces::g_Engine->GetLocalPlayer());

	float current_time = m_local->GetTickBase() * Interfaces::g_Globals->interval_per_tick;
